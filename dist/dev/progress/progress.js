System.register(['aurelia-templating', 'aurelia-binding', 'aurelia-dependency-injection'], function (_export) {
  ...
  var bindable, customElement, bindingMode, inject, MdProgress;
  ...
  return {
    ...
    execute: function () {
      MdProgress = (function () {
        ...
        MdProgress = inject(Element)(MdProgress) || MdProgress;
        MdProgress = customElement('md-progress')(MdProgress) || MdProgress;
        return MdProgress;
      })();
