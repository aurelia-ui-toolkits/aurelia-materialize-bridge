System.register(['aurelia-templating', 'aurelia-dependency-injection'], function (_export, _context) {
  ...
  var bindable, customAttribute, inject, _dec, _dec2, _dec3, _dec4, _dec5, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, MdPushpin;
  ...
  return {
    ...
    execute: function () {
      _export('MdPushpin', MdPushpin = (_dec = customAttribute('md-pushpin'), _dec2 = inject(Element), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable(), _dec(_class = _dec2(_class = (_class2 = function () {
      ...
      _export('MdPushpin', MdPushpin);
    }
  };
});
//# sourceMappingURL=../devbuild/dev/pushpin/pushpin.js.map
