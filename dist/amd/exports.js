define(["require", "exports", "tslib", "./autocomplete/autocomplete", "./badge/badge", "./box/box", "./breadcrumbs/breadcrumbs", "./breadcrumbs/instructionFilter", "./button/button", "./card/card", "./carousel/carousel-item", "./carousel/carousel", "./char-counter/char-counter", "./checkbox/checkbox", "./chip/chip", "./chip/chips", "./collapsible/collapsible", "./collection/collection-header", "./collection/collection-item", "./collection/collection", "./collection/md-collection-selector", "./colors/color-value-converters", "./colors/md-colors", "./common/attributeManager", "./common/attributes", "./common/constants", "./common/events", "./datepicker/datepicker-default-parser", "./datepicker/datepicker", "./dropdown/dropdown-element", "./dropdown/dropdown", "./fab/fab", "./file/file", "./footer/footer", "./input/input-prefix", "./input/input", "./modal/modal", "./navbar/navbar", "./pagination/pagination", "./parallax/parallax", "./progress/progress", "./pushpin/pushpin", "./radio/radio", "./range/range", "./scrollspy/scrollspy", "./select/select", "./sidenav/sidenav-collapse", "./sidenav/sidenav", "./slider/slider", "./switch/switch", "./tabs/tabs", "./tap-target/tap-target", "./timepicker/timepicker", "./toast/toastService", "./tooltip/tooltip", "./transitions/fadein-image", "./transitions/staggered-list", "./validation/validationRenderer", "./waves/waves", "./well/md-well", "./config-builder"], function (require, exports, tslib_1, autocomplete_1, badge_1, box_1, breadcrumbs_1, instructionFilter_1, button_1, card_1, carousel_item_1, carousel_1, char_counter_1, checkbox_1, chip_1, chips_1, collapsible_1, collection_header_1, collection_item_1, collection_1, md_collection_selector_1, color_value_converters_1, md_colors_1, attributeManager_1, attributes_1, constants_1, events_1, datepicker_default_parser_1, datepicker_1, dropdown_element_1, dropdown_1, fab_1, file_1, footer_1, input_prefix_1, input_1, modal_1, navbar_1, pagination_1, parallax_1, progress_1, pushpin_1, radio_1, range_1, scrollspy_1, select_1, sidenav_collapse_1, sidenav_1, slider_1, switch_1, tabs_1, tap_target_1, timepicker_1, toastService_1, tooltip_1, fadein_image_1, staggered_list_1, validationRenderer_1, waves_1, md_well_1, config_builder_1) {
    "use strict";
