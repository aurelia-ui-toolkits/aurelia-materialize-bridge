System.register(['aurelia-templating', 'aurelia-binding', 'aurelia-dependency-injection'], function (_export) {
  ...
  var bindable, customElement, bindingMode, inject, MdCarouselItem;
  ...
  return {
    ...
    execute: function () {
      MdCarouselItem = (function () {
        ...
        MdCarouselItem = inject(Element)(MdCarouselItem) || MdCarouselItem;
        MdCarouselItem = customElement('md-carousel-item')(MdCarouselItem) || MdCarouselItem;
