...
System.register(['aurelia-templating', 'aurelia-binding', 'aurelia-dependency-injection', '../common/events', '../common/attributes'], function (_export, _context) {
  ...
  var bindable, customElement, bindingMode, inject, fireMaterializeEvent, getBooleanFromAttributeValue, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, MdPagination;
  ...
  return {
    ...
    execute: function () {
      _export('MdPagination', MdPagination = (_dec = customElement('md-pagination'), _dec2 = inject(Element), _dec3 = bindable({
        ...
        defaultBindingMode: bindingMode.oneWay
      }), _dec7 = bindable(), _dec8 = bindable(), _dec9 = bindable(), _dec(_class = _dec2(_class = (_class2 = function () {
