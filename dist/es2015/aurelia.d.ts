...
export { customElement, customAttribute, autoinject, bindingMode, BindingEngine, TaskQueue, DOM, children } from "aurelia-framework";
...
export { bindable, observable } from "aurelia-typed-observable-plugin";
